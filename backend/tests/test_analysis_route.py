...
class AnalysisRouteTests(unittest.TestCase):
    ...
    @patch("app.routes.analysis.build_stock_score")
    def test_score_success(self, mock_build_stock_score):
        mock_build_stock_score.return_value = {
            "symbol": "AAPL",
            "score": 75,
    ...
    @patch("app.routes.analysis.build_stock_score", side_effect=MisconfigurationError)
    ...
    @patch("app.routes.analysis.build_stock_score", side_effect=ValueError("upstream"))
    ...
    @patch("app.routes.analysis.build_stock_score", side_effect=RuntimeError("boom"))
